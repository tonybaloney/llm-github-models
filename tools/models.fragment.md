...
| Phi-3-mini instruct (4k) | ❌ | ❌ | text | text |
| Phi-3-small instruct (128k) | ❌ | ❌ | text | text |
| Phi-3-small instruct (8k) | ❌ | ❌ | text | text |
| Phi-3.5-mini instruct (128k) | ❌ | ❌ | text | text |
| Phi-3.5-MoE instruct (128k) | ❌ | ❌ | text | text |
| Phi-4 | ❌ | ❌ | text | text |
